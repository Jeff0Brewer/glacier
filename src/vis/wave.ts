...
import vertSource from '../shaders/wave-vert.glsl?raw'
import fragSource from '../shaders/wave-frag.glsl?raw'
...
const calcFlowLine = (
    ...
    for (i = 0; i < history; i++) {
        ...
        avgSpeed /= calcInd
        const top = vec3.fromValues(lastPos[0], lastPos[1], lastPos[2] + 30.0)
        const bottom = vec3.fromValues(lastPos[0], lastPos[1], 0.0)
        verts.set([
            top[0],
            top[1],
            top[2],
